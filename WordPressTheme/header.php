  ...
  <header class="p-header l-header">
    <div class="p-header__inner">
      <h1 class="p-header__logo c-logo">
        <a href="<?php echo get_template_directory_uri() ?>./front-page.php" class="c-logo__link">
      ...
      <div class="p-header-nav p-pc-global-nav">
        <ul class="p-pc-global-nav__items">
          <li class="p-pc-global-nav__item"><a href="<?php echo get_template_directory_uri() ?>./index.php">トップ</a></li>
    ...
    <div class="p-header-nav p-sp-global-nav js-drawer-menu">
      <ul class="p-sp-global-nav__items">
        <li class="p-sp-global-nav__item"><a href="<?php echo get_template_directory_uri() ?>./index.php">トップ</a></li>

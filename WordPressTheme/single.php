...
<!-- パンくずリスト -->
<div class="single-works__breadcrumb">
<?php get_template_part('template-parts/breadcrumb'); ?>
</div>

<div class="single-works__contents">
      <div class="l-inner">
        <div class="single-works__mainbox">
          <div class="single-works__header">
            <h1 class="single-works__title">
              〇〇株式会社　制作実績
            </h1>
            <div class="single-works__info">
              <time class="single-works__date date" datetime="2021-06-13">2020/06/13</time>
              <span class="single-works__label label">カテゴリ１</span>
            </div>
          </div>
          <div class="single-works__body">
            <div class="single-works__slider swiper">
              <!-- メインスライダー -->
              ...
              <!-- サムネイル -->
            <div class="swiper single-works__thumbs">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="./assets/images/sigle-works/single-works1.jpg" alt=""></div>
                <div class="swiper-slide"><img src="./assets/images/sigle-works/single-works2.jpg" alt=""></div>
                <div class="swiper-slide"><img src="./assets/images/sigle-works/single-works3.jpg" alt=""></div>
            ...
            <div class="single-works__item box">
          ...
          <!-- ページネーション -->
          <div class="single-works__pagenation pagenation">
        ...
        <!-- おすすめ・関連記事 -->
        <div class="single-works__content recommend-article">
